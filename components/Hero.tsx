...
import { ArrowRight, Play, Activity, CheckCircle2 } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="text-center lg:text-left">
            <div className="inline-flex items-center gap-3 bg-white/5 border border-white/10 px-5 py-2.5 rounded-full text-white text-sm font-semibold mb-8 backdrop-blur-md">
              <span className="flex h-2.5 w-2.5 rounded-full bg-[#007BFF] animate-pulse"></span>
              NewRead Enterprise <span className="text-slate-500">|</span> <span className="text-[#FFB35B]">High Precision IoT</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-5 justify-center lg:justify-start">
              ...
              <button className="bg-white/5 hover:bg-white/10 border border-white/10 text-white px-10 py-5 rounded-2xl font-bold text-xl flex items-center justify-center gap-2 transition-all">
                <Play className="w-6 h-6 fill-current text-[#FFB35B]" />
                Assista o Vídeo
              </button>
            </div>
            ...
            <div className="mt-16 flex items-center justify-center lg:justify-start gap-12">
              <div className="flex flex-col">
                ...
                <span className="text-[10px] uppercase font-bold tracking-[0.2em] text-[#FFB35B]">Redução de Glosas</span>
              </div>
              <div className="w-px h-12 bg-white/10"></div>
              <div className="flex flex-col">
                <span className="text-3xl font-black text-white">100k+</span>
                <span className="text-[10px] uppercase font-bold tracking-[0.2em] text-[#FFB35B]">Unidades Ativas</span>
              </div>
            </div>
          </div>
          ...
          <div className="relative hidden lg:block">
            <div className="relative z-20 group">
              <div className="absolute -inset-10 bg-[#007BFF]/10 blur-[120px] rounded-full group-hover:bg-[#007BFF]/20 transition-all duration-1000"></div>
              
              <div className="relative bg-slate-900 border border-white/10 rounded-[40px] shadow-[0_50px_100px_-20px_rgba(0,0,0,0.8)] p-2">
                <div className="bg-slate-950 rounded-[32px] border border-white/5 overflow-hidden">
                  <img 
                    ...
                    className="w-full h-auto opacity-90 group-hover:scale-105 transition-transform duration-[2000ms]"
                  />
                </div>
              </div>
